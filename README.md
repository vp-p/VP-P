...
Presently, I am focused on building reliable, maintainable back‑end systems using Spring (JPA, Hibernate), Java EE, and MySQL. My interests extend to large language models (LLMs) and AI-integrated data pipelines.
